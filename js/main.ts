...
module uncrustify_config
{
    ...
    const optionNameString_Map = new Map<string, string>( [
        ...
        ["sp_after_semi", exampleStringEnum_string_Map.get( ExampleStringEnum.paren) ],
        ["sp_after_semi_for", exampleStringEnum_string_Map.get( ExampleStringEnum.paren) ],
        ["sp_after_semi_for_empty", exampleStringEnum_string_Map.get( ExampleStringEnum.paren) ],
